    ...
    <main>
        ...
        <section class="mt-3">
            <div class="container-fluid">
                ...
                <p class="text-center">Introduzca los datos de la cerveza que desee modificar. No es obligatorio
                    completar todos los campos.</p>
                <form action="modificar_prod.php" method="post" enctype="multipart/form-data">
                    <fieldset class="p-5">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="denominacion" id="denominacion" class="form-control"
                                    value="<?= $producto['Denominacion_Cerveza'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <select name="marca" id="marca" class="form-select">
                                    ...
                                    <option value="Heineken" <?= ($producto["Marca"] == "Heineken") ? "selected" : "" ?>>
                                        Heineken</option>
                                    <option value="Mahou" <?= ($producto["Marca"] == "Mahou") ? "selected" : "" ?>>Mahou
                                    </option>
                                    <option value="Damm" <?= ($producto["Marca"] == "Damm") ? "selected" : "" ?>>Damm
                                    </option>
                                    <option value="Estrella Galicia" <?= ($producto["Marca"] == "Estrella Galicia") ? "selected" : "" ?>>Estrella Galicia</option>
                                    <option value="Alhambra" <?= ($producto["Marca"] == "Alhambra") ? "selected" : "" ?>>
                                        Alhambra</option>
                                    <option value="Cruzcampo" <?= ($producto["Marca"] == "Cruzcampo") ? "selected" : "" ?>>
                                        Cruzcampo</option>
                                    <option value="Artesana" <?= ($producto["Marca"] == "Artesana") ? "selected" : "" ?>>
                                        Artesana</option>
                                </select>
                        ...
                        <!-- Tipo de Cerveza -->
                        <div class="mb-3 d-flex flex-nowrap gap-3 justify-content-between align-items-center">
                        ...
                        <div class="mb-3 d-flex flex-nowrap gap-3 justify-content-between">
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                ...
                                // Obtiene los alérgenos seleccionados desde la base de datos
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="date" name="fecha" id="fecha" class="form-control"
                                    value="<?php echo $producto['Fecha_Consumo']; ?>">
                            </div>
                        </div>
                        ...
                        <!-- Observaciones -->
                        <div class="mb-3 row">
                            <label for="observaciones" class="col-sm-4 col-form-label fw-bold">Observaciones:</label>
                            <div class="col-sm-8">
                                <textarea name="observaciones" id="observaciones"
                                    class="form-control"><?php echo $producto['Observaciones']; ?></textarea>
