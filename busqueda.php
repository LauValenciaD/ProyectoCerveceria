...
// El usuario tiene las mismas opciones del catálogo
...
if (isset($_POST["submit"])) {
    ...
    // Prepara la consulta SQL sengún los campos que se hayan rellenado (se puede filtrar por varios campos)
...
<body>
    ...
    <main>
        <section>
                    ...
                    <div class="row d-flex justify-content-center align-items-center h-100">
                        ...
                        <div class="col-md-6 col-lg-8 col-xl-7 offset-xl-1">
                            <div class="container my-4">
                                ...
                                <p class="text-center">Introduzca los datos de la cerveza. No es necesario completar
                                    todos los campos.</p>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="mb-3 row">
                                            <label for="denominacion"
                                                class="col-sm-4 col-form-label fw-bold">Denominación
                                                cerveza:</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="formato"
                                                class="col-sm-4 col-form-label fw-bold">Formato:</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="cantidad"
                                                class="col-sm-4 col-form-label fw-bold">Tamaño:</label>
                                            <div class="col-sm-8">
            ...
            <?php
            if ($sinResultados === false && $seBusco === true) { // Si no se encontraron resultados esta tabla no se imprime
                echo '<section>';
        ...
        <thead class='table-info'>
            ...
            } elseif ($seBusco === true && $sinResultados === true) { // no se encontraron datos
