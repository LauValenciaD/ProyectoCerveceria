...
//                    }
      ...
      <div class="container d-flex justify-content-between align-items-center" id="header">
        ...
        <button
          ...
          data-bs-target="#container_main_nav"
          aria-controls="container_main_nav"
          aria-expanded="false"
        ...
        >
          <span class="navbar-toggler-icon"></span>
               ...
               <!--  menu collapse -->
               <div
               class="collapse navbar-collapse flex-fill d-lg-flex justify-content-lg-center"
        ...
        <div class="navbar align-self-center d-flex flex-nowrap" id="grupoIconos">
          <a
            class="nav-icon d-inline d-lg-none"
            href="#"
            data-bs-toggle="modal"
            data-bs-target="#container_search"
                    ...
                    <div class="row d-flex justify-content-center align-items-center h-100">
                        <div class="col-md-9 col-lg-6 col-xl-5">
                            <img src="./assets/img/cerveza.jpg"
                                 class="img-fluid rounded" alt="Logo cerveceria">
                        </div>
                        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                            ...
                            <form action="index.php" method="post">
                                ...
                                <div>
                                    <p><strong>Nota:</strong> El usuario se llama <strong>user@gmail.com</strong> y su contraseña también es <strong>user</strong>.
                                    </p>
                                    <p>
                                        <strong>Nota:</strong> El Administrador se llama <strong>root</strong> y su contraseña también es <strong>root</strong>.
                                    </p>
                                </div>

                                <div class="text-center text-lg-start mt-4 pt-2">
                                    <input  type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg"
                                             style="padding-left: 2.5rem; padding-right: 2.5rem;" value="Iniciar sesión">
    ...
    <p class="text-center text-body-secondary">© 2025. Hecho por Laura Valencia</p>
  </footer>
